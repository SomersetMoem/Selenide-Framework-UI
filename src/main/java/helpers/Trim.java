...
public class Trim {
    ...
    /**
     * Метод удаляет заданный символ из начала и конца строки. Если символ не передан, то удаляет пробелы.
    ...
    /**
     Метод удаляет символы-разделители из начала переданной строки.
